...
export default function ResumePage() {
  const { resume, brand, contact } = SITE_DATA;
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
              ...
              <p className="text-cyan-400 text-lg mt-2">{brand.title}</p>
              <p className="text-slate-400 text-sm mt-1">{contact.location} • {contact.email}</p>
            </div>
            <a 
